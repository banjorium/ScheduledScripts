...
function GetFormattedPingResultsFromHashTable
{
  ...
  #END of GetFormattedPingResultsFromHashTable Function
...
#BEGIN GetFormattedPingAndDNSResults Function
...
Out-File "C:\users\j.lafontaine\desktop\computer removal objects\OldComputers_$currentdate.html"
...
$Body = @"
Please find attached a report containing computers slated for deletion on $dateofdeletion

These computers have been tested and have been labeled as inactive.
